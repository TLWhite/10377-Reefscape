...
public class ArmConstants {
    public static final int ARM_MOTOR_ID = 3; // TODO: Replace with your actual CAN ID
    ...
    public static final double MAX_POS = 0.7; // Max arm position (TODO: Tune)
    public static final double MIN_POS = 0.109; // Min arm position (TODO: Tune)
    ...
    public static final double KF_COEFFICIENT = 0.02; // Feedforward coefficient (TODO: Tune)
    ...
    public static final double MIN_SAFE_FOLD_POS = 0.1; // Replace with the correct value
    public static final double MAX_SAFE_FOLD_POS = 0.9; // Replace with the correct value
