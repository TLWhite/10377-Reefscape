...
public class ArmSP extends SubsystemBase {
    /**
     * Creates a new arm subsystem. This class controls the arm motor and allows for various actions like manual
     * control, setting arm positions, and running PID-based control to maintain precise arm positioning.
     */
    ...
    public void setMotor(double power) {
        ...
        output = Math.sin(getarmPosition() * 2 * Math.PI) * .02
                + limitedSpeed; // TODO tune for KF to aviod droopy arm because of gravity
    ...
    public Command armPIDCommandDefault(BooleanSupplier canFold) {
        return new FunctionalCommand(
                ...
                interrupted -> {}, // Interrupted: No specific action when interrupted
                () -> {
