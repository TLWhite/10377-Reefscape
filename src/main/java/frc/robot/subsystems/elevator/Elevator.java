...
public class Elevator extends SubsystemBase {
    ...
    public void periodic() {
        ...
        if (isHomed) {
            ...
            double outputPower =
                    MathUtil.clamp(pidOutput + ff, -ElevatorConstants.max_output, ElevatorConstants.max_output);
    ...
    public void setPositionInches(double inches) {
        ...
        setpoint = MathUtil.clamp(inches, ElevatorConstants.minPos, ElevatorConstants.maxPos);
    ...
    public boolean isAtPosition(ElevatorPosition position) {
        return pidController.atSetpoint() && Math.abs(getHeightInches() - position.positionInches) < 0.5;
    }
